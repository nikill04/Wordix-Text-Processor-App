...
export default function Navbar({ mode, toggleMode, title = 'Set title here', aboutText = 'About' }) { 
    // We should give default values in the parameters itself.

    return (
        <div>
            {/* <a href="">  </a>  ==> Replace 'a' with 'Link' and 'href' with 'to' WHEN WE USE ROUTES */}
            ...
            <nav className={`navbar navbar-expand-lg navbar-${mode} bg-${mode}`}>
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div className="d-flex rounded align-items-center" style={{height: '42px', background: 'rgb(108 117 125 / 53%)'}}>
                            {/* 'onClick' requires an function NOT an function call. So, we should not use "onClick={toggleMode('primary')}" directly, as it is a function call*/}
